...
export class APIClient extends CoreClient {
    ...
    createUser(i: CreateUserInput) {
        return this.request<User>("createUser", i);
    }
    createPlace(i: CreatePlaceInput) {
        return this.request<Place>("createPlace", i);
    }
    getPlace(i: GetPlaceInput) {
        return this.request<Place | null>("getPlace", i);
    }
    listPlaces(i: ListPlacesInput) {
        return this.request<{results: Place[], pageInfo: any}>("listPlaces", i);
    }
    ...
    queries = {
        ...
        listPlaces: this.listPlaces.bind(this),
    }
    mutations = {
        getPlace: this.getPlace.bind(this),
        listPlaces: this.listPlaces.bind(this),
